...
<template>
  <footer class="footer-container">
    <div class="footer-options">
      <div class="logo-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 148 25" class="logo-svg">
          <g fill="none" fill-rule="evenodd">
            ...
            />
            <g>
              <circle fill="#5267DF" cx="12.5" cy="12.5" r="12.5" class="path-circle" />
              <path
    ...
    <div class="social-media-container">
      <Icon :src="FacebookIcon" alt="Facebook icon" class="social-media-container__facebook-icon" />
      <Icon :src="TwitterIcon" alt="Twitter icon" class="social-media-container__twitter-icon" />
    </div>
  </footer>
</template>
...
.footer-container {
  ...
  background-color: map.get($colors, 'neutral-blue-950');
  padding: 3em 1.5em;
  .footer-options {
  ...
  .social-media-container {
    ...
    &__facebook-icon {
      ...
      transition:
        filter 0.1s ease;
      &:hover {
        filter: brightness(0) saturate(100%) invert(48%) sepia(40%) saturate(3571%) hue-rotate(330deg) brightness(105%) contrast(90%);
      }
    }
  }
}
@media (min-width: $desktop-small) {
  .footer-container {
    ...
    .footer-options {
      flex-direction: row;
      @include set-gap(0, 6em);
      min-width: 50%;
    }
    .social-media-container {
      @include grid-child(13, 13);
    }
  }
}
@media (min-width: $desktop-wide) {
  .footer-container {
    .footer-options {
      @include grid-child(2, 7);
    }
    .social-media-container {
      @include grid-child(11, 12);
    }
  }
}
